...
import (
	...
	_ "github.com/soojae/simplebank/doc/statik"
	"github.com/soojae/simplebank/gapi"
...
// runGatewayServer initializes and starts the gRPC Gateway server
func runGatewayServer(config util.Config, store db.Store) {
	...
	listener, err := net.Listen("tcp", config.HTTPSServerAddress)
	if err != nil {
		log.Fatal("cannot listen: ", err)
	}

	log.Printf("start Http gateway server listening on %s", listener.Addr().String())
